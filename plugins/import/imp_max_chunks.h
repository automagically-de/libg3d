...
static MaxChunk max_chunks[] = {
	...
	{ 0x010A, 0x08FE, "triangles",                 max_cb_0x08FE_0x010A },
	{ 0x0110, 0x08FE, "[DEBUG] 4",                 max_cb_debug_int32 },
	{ 0x0114, 0x08FE, "[DEBUG] 4",                 max_cb_debug_int32 },
	{ 0x011A, 0x08FE, "[DEBUG] normals?",          max_cb_debug_int32 },
	{ 0x0120, 0x08FE, "[DEBUG] 4",                 max_cb_debug_int32 },
	{ 0x0124, 0x08FE, "[DEBUG] 4",                 max_cb_debug_int32 },
	{ 0x0128, 0x08FE, "texture vertices",          max_cb_debug_int32 },
	{ 0x012B, 0x08FE, "polygon indices",           max_cb_debug_int32 },
